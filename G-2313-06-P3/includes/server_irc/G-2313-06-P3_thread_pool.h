...
#define THREAD_POOL_MAX_THREADS 100
#define THREAD_POOL_MIN_THREADS 10
...
{
    SSL *arg; /*the arg of task callback function*/
    void *(*task_callback)(SSL *arg); /*task callback function*/
...
/*init a task*/
void task_init(task_t *, void* (*)(SSL*), SSL *arg);
